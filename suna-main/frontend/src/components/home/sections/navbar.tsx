      ...
      >
        <div
          className={cn(
            ...
            hasScrolled
              ? 'px-2 md:px-2 border border-border backdrop-blur-lg bg-white/95'
              : 'shadow-none px-3 md:px-7 bg-white',
          )}
        >
            ...
            <div className="flex items-center justify-start flex-shrink-0 w-auto md:w-[200px]">
              <Link href="/" className="flex items-center gap-3">
                <Image
                  ...
                  width={120}
                  height={28}
                  className="w-[100px] h-[24px] md:w-[140px] md:h-[32px] object-contain"
                  priority
                /> 
              </Link>
            </div>
