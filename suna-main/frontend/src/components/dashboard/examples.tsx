...
#### 정확한 셀 위치에 내용 입력:
- **A1:L4**: "회의록" (제목)
- **B7:F8**: [YYYY-MM-DD HH:MM] (일시)
- **H7:L8**: [회의 장소] (장소)
- **B9:F10**: [작성자명] (작성자)
- **H9:L10**: [YYYY-MM-DD] (작성일)
- **B11:L12**: [참석자1, 참석자2, ...] (참석자)
- **B13:L14**: [안건 내용] (안건)
- **B19:L40**: [회의 전체 내용 요약] (요약내용)
- **B41:L47**: [결정사항 목록] (결정사항)
- **B48:L53**: [특이사항] (특이사항)
...
### 5. Google Sheets 생성 규칙

1. **스프레드시트 생성**: mcp 도구를 사용하여 Google Sheets 생성
...
1. Google Sheets 회의록 오픈
2. 기본 템플릿 구조 설정 (고정 항목들)
