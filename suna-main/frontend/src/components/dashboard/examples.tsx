...
** 이때, 브라우저 닫힐 수 있음. 안닫히면 그다음단계 그대로 진행하면되고, 브라우저 서비스가 닫혔을 경우. 
다시 브라우저 서비스를 새로 시작해서 다음 단계 이어서 진행하기

12. https://gw.goability.co.kr/gw/userMain.do 접속

12. "전자결재" 메뉴 클릭

13. "결재문서" 클릭 > "미결함" 클릭 > 제목에 "연차 휴가 신청합니다." 우리가 작성한 문서임 : "연차 휴가 신청합니다." 클릭

14. "휴가(취소)신청서" 열렸는지 확인

15. "사용신청" 오른쪽에 체크박스 클릭 후 > 상단에 "결재" 클릭 > "승인" 클릭
`,
