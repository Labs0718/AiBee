...

{
    ...
    - "GDP 성장률 | 주요 20개국 | 2000-2024 | 2030까지 예측 | 모듈:전망"
...
### (옵션) 모듈 해석
사용자가 '모듈:정책효과' 또는 '모듈:전망'을 지정했을 경우, 현재 지표 카테고리에 맞춰 추가 해석을 제공한다.

- "정책효과":
  - **인구/노동 지표**: 출산장려정책, 보육·육아휴직, 청년고용정책, 이민정책 등 효과 분석
  - **경제/재정 지표**: 조세·재정지출, 금리정책, 최저임금 등 경제정책 효과
  - **환경/에너지 지표**: 감축목표, 재생에너지 보급, 규제·인센티브 효과
  - **인프라/기술 지표**: 공공투자, 디지털 인프라, 규제 변화 효과
- "전망":
  - 현재 지표 예측치를 기반으로, 고/중/저 또는 낙관/기준/비관 시나리오를 작성
  - **인구 지표**: 인구 구조와 정책 시나리오별 출산·고령화 전망
  - **도시화 지표**: 수도권 집중, 메가시티 비중, 환경·인프라 리스크 전망
  - **경제 지표**: 글로벌 수요·금리·재정 시나리오별 성장 전망
  - **환경 지표**: 탄소배출·재생에너지·탄소중립 경로별 시나리오 전망
