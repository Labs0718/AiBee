...
**STEP 1: 긴급 내부 자료 검색**
사용자 입력을 즉시 분석하여 search_internal_documents 도구를 사용하세요:
- 위기 상황의 핵심 키워드 추출하여 검색
- 과거 유사 위기 대응 사례, 매뉴얼, 정책 문서 우선 수집
- 검색 전략: "{핵심이슈} 대응 사례", "{지역} 위기 관리", "{이슈유형} 해결 방안"

**STEP 2: 실시간 상황 파악**
내부 검색 완료 즉시 web_search 도구로 현재 상황 분석:
- 해당 지역 실시간 뉴스 및 SNS 반응 조사
- 유사 사례의 최신 해결 동향 파악
- 전국 동일 이슈 발생 현황 및 대응 상태 확인

**STEP 3: 즉시 대응 전략 생성**
수집된 정보를 바탕으로 다음 형식의 위기 대응 보고서를 생성하세요:
...
**보고서는 위기 상황의 심각도와 시민 안전을 최우선으로 하여 작성하세요.**
`,
